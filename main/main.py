...
class Application(tk.Tk, serial):
    def __init__(self):
        tk.Tk.__init__(self)
    ...
    def emissionArduino(self, com_arduino, message):
        print("Ecriture sur la liaison serie...")
        com_arduino.write(message)

    def fermer_liaisonArduino(self, com_arduino):
